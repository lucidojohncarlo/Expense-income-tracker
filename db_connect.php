...
$host = getenv('DB_Server') ?: 'johncarlolucido.mysql.database.azure.com';
$dbname = getenv('DB_Database') ?: 'budget_tracker';
$username = getenv('DB_Username') ?: 'johncarlolucido';
$password = getenv('DB_Password') ?: 'Jhared123'; // replace with actual password or use env variable
